...
(function () {
    function r(e, n, t) {
    ...
    }, { "./readMore": 6 }], 3: [function (require, module, exports) {
        /* jqueryLazy JS */
        'use strict';
        ...
        (function ($) {
            ...
            function _lazyLoad() {
                var lazy = lazyload.$el.Lazy(lazyload.options);
                return lazy;
            }
    ...
    }, { "jquery-lazy": 1 }], 4: [function (require, module, exports) {
        /* Menu JS */
        'use strict';
        ...
        function TheMenu(id) {
            ...
            this.sandwitch = function () {
                var button = document.querySelectorAll(this.id);
        ...
        var mainMenu = new TheMenu('[data-toggle="menu"]');
        ...
        */
        ...
        module.exports = function (button, options) {
            ...
            var elClass = options.class === undefined ? 'show' : options.class,
        ...
        */
        ...
        require('./app/menu');
        //require('./app/example');
    }, { "./app/custom": 2, "./app/jqueryLazy": 3, "./app/menu": 4, "./app/pageUp": 5, "./app/sliders": 7 }] }, {}, [8]);
